...
@section('content')
        ...
        <div class="portfolio-modal modal modal-add-update fade show"  tabindex="-1" style="display: none;" aria-modal="true" role="dialog">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="container">
                        <div class="text-center">
                            <h2 class="category text-uppercase">Category: </h2>
                            <br />
                        </div>
                            ...
                            <div class="row align-items-stretch mb-5">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <!-- Name input-->
                                        <div class="form-group">
                                            <textarea class="m-2 form-control" id="briefing" oninput="setCustomValidity('')"
                                                   oninvalid="this.setCustomValidity('Please enter a briefing')" placeholder="Briefing *"
    ...
    <script src="{{scriptUrl('categories.js')}}"></script>
